...
async def process_track_metadata(track_data: dict, album_data: dict, user: dict):
    ...
    metadata = {
        ...
        'title': str(track_data.get('songTitle', '')).replace('/', '-'),
        'artist': str(album_data.get('artistName', '')).replace('/', '-'),
        'albumartist': str(album_data.get('artistName', '')).replace('/', '-'),
        'album': str(album_data.get('containerInfo', '')).replace('/', '-'),
...
async def start_album(album_id: str, user: dict, upload=True):
    ...
    album_meta = {
        ...
        'type': 'album',
        'itemid': album_id,
        'title': str(album_data.get('containerInfo', '')).replace('/', '-'),
        'artist': str(album_data.get('artistName', '')).replace('/', '-'),
        'albumartist': str(album_data.get('artistName', '')).replace('/', '-'),
